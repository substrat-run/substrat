...
verticals exist across eight unrelated domains, and three of them compose no engine at
all; that set was represented by three cards near the bottom.
...
twenty-two things that arrive with a project — the API and its client, identity and the
