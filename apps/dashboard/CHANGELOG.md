...
- Updated dependencies [e7113ea]
  ...
  - @substrat-run/demo-callout@0.3.37
  - @substrat-run/engine-invites@0.8.3
  - @substrat-run/engine-invoicing@0.11.3
  - @substrat-run/engine-protocol@0.13.3
  - @substrat-run/engine-workorder@0.12.3
...
- 429cc84: Apps that sign in with a team auth server are now registered there as places, so the auth server's **Your account** page can list them for the people who use them.
...
- Updated dependencies [429cc84]
  ...
  - @substrat-run/demo-callout@0.3.36
  - @substrat-run/connector-fortnox@0.4.20
  - @substrat-run/engine-invites@0.8.2
  - @substrat-run/engine-invoicing@0.11.2
  - @substrat-run/engine-protocol@0.13.2
  - @substrat-run/engine-workorder@0.12.2
...
- 605c8a1: A vertical's page now lists the apps still installed on it, and you can move or retire them from there.
...
- Updated dependencies [0b993ff]
  ...
  - @substrat-run/engine-invites@0.8.0
  - @substrat-run/engine-invoicing@0.11.0
  - @substrat-run/engine-protocol@0.13.0
  - @substrat-run/engine-workorder@0.12.0
  - @substrat-run/demo-callout@0.3.34
...
- Updated dependencies [f58aa74]
  ...
  - @substrat-run/demo-callout@0.3.32
  - @substrat-run/engine-invites@0.7.13
  - @substrat-run/engine-invoicing@0.10.4
  - @substrat-run/engine-protocol@0.12.19
  - @substrat-run/engine-workorder@0.11.13

## 0.35.4

### Patch Changes

- 7d3e88c: Documentation only: two open questions in the plan for retiring the dashboard's own directory are now answered, and the constraint that shapes the whole job is written down.
...
- Updated dependencies [7e6f925]
  ...
  - @substrat-run/demo-callout@0.3.31
  - @substrat-run/engine-invites@0.7.12
...
- Updated dependencies [cb88aa1]
  ...
  - @substrat-run/engine-invoicing@0.10.0
  - @substrat-run/connector-fortnox@0.4.12
  - @substrat-run/demo-callout@0.3.28
  - @substrat-run/engine-invites@0.7.9
  - @substrat-run/engine-protocol@0.12.15
  - @substrat-run/engine-workorder@0.11.9
...
- 919a20a: Release health stops reading "not visible" as "zero", and stops hiding itself
  (follow-up to #1236).
...
- Updated dependencies [2956182]
  ...
  - @substrat-run/demo-callout@0.3.24
  - @substrat-run/engine-invites@0.7.5
  - @substrat-run/engine-invoicing@0.9.22
  - @substrat-run/engine-protocol@0.12.11
  - @substrat-run/engine-workorder@0.11.5
...
- Updated dependencies [5201683]
  ...
  - @substrat-run/demo-callout@0.3.23
  - @substrat-run/connector-fortnox@0.4.7
  - @substrat-run/engine-protocol@0.12.10
  - @substrat-run/engine-invites@0.7.4
  - @substrat-run/engine-invoicing@0.9.21
  - @substrat-run/engine-workorder@0.11.4
...
- be664ce: Freshness health is on the app page (#1232, completing the view #1272's record
...
- Updated dependencies [6b3e466]
  ...
  - @substrat-run/demo-callout@0.3.18
  - @substrat-run/connector-fortnox@0.4.2
  - @substrat-run/engine-protocol@0.12.5
  - @substrat-run/engine-invites@0.6.6
  - @substrat-run/engine-invoicing@0.9.16
  - @substrat-run/engine-workorder@0.10.8
...
- Updated dependencies [ee70af5]
  ...
  - @substrat-run/demo-callout@0.3.16
  - @substrat-run/engine-protocol@0.12.3
  - @substrat-run/engine-invites@0.6.4
  - @substrat-run/engine-invoicing@0.9.14
  - @substrat-run/engine-workorder@0.10.6
...
- Updated dependencies [59121f6]
  ...
  - @substrat-run/demo-callout@0.3.15
  - @substrat-run/demo-manyfold@0.7.14
  - @substrat-run/demo-meridian@0.7.10
  - @substrat-run/engine-absence@0.5.9
  - @substrat-run/engine-invites@0.6.3
...
- Updated dependencies [a4704de]
  ...
  - @substrat-run/demo-callout@0.3.14
  - @substrat-run/demo-manyfold@0.7.13
  - @substrat-run/demo-meridian@0.7.9
  - @substrat-run/engine-absence@0.5.8
  - @substrat-run/engine-invites@0.6.2
  - @substrat-run/engine-invoicing@0.9.12
  - @substrat-run/engine-protocol@0.12.1
  - @substrat-run/engine-workorder@0.10.4
...
- Updated dependencies [4f641a7]
  ...
  - @substrat-run/engine-absence@0.5.7
  - @substrat-run/engine-invites@0.6.1
  - @substrat-run/engine-protocol@0.11.12
  - @substrat-run/engine-invoicing@0.9.11
  - @substrat-run/demo-meridian@0.7.7
  - @substrat-run/demo-callout@0.3.12
  - @substrat-run/demo-manyfold@0.7.11
  - @substrat-run/engine-workorder@0.10.3
...
- Updated dependencies [35147a9]
  - @substrat-run/engine-workorder@0.10.2
  - @substrat-run/engine-protocol@0.11.11
  - @substrat-run/engine-absence@0.5.6
  - @substrat-run/engine-invites@0.6.0
  - @substrat-run/engine-invoicing@0.9.10
  - @substrat-run/contracts@0.94.0
  - @substrat-run/adapter-cloudflare@0.94.0
  - @substrat-run/kernel@0.94.0
  - @substrat-run/demo-callout@0.3.11
  - @substrat-run/demo-manyfold@0.7.10
  - @substrat-run/demo-meridian@0.7.6
...
- Updated dependencies [0a536b7]
  ...
  - @substrat-run/demo-callout@0.3.10
  - @substrat-run/demo-manyfold@0.7.9
  - @substrat-run/demo-meridian@0.7.5
  - @substrat-run/engine-absence@0.5.5
  - @substrat-run/engine-invites@0.5.3
  - @substrat-run/engine-invoicing@0.9.9
  - @substrat-run/engine-protocol@0.11.10
  - @substrat-run/engine-workorder@0.10.1

## 0.28.8

### Patch Changes

- Updated dependencies [9f1018e]
- Updated dependencies [7843c4f]
- Updated dependencies [d9793bc]
- Updated dependencies [7ad9ec8]
  - @substrat-run/engine-absence@0.5.4
  - @substrat-run/contracts@0.92.0
  - @substrat-run/adapter-cloudflare@0.92.0
  - @substrat-run/engine-workorder@0.10.0
  - @substrat-run/demo-callout@0.3.9
  - @substrat-run/demo-manyfold@0.7.8
  - @substrat-run/demo-meridian@0.7.4
  - @substrat-run/engine-invites@0.5.2
...
- Updated dependencies [75bd27c]
  ...
  - @substrat-run/demo-meridian@0.7.3
  - @substrat-run/demo-manyfold@0.7.7
  - @substrat-run/demo-callout@0.3.8
  - @substrat-run/engine-absence@0.5.3
  - @substrat-run/engine-invites@0.5.1
...
- Updated dependencies [3561f7f]
  ...
  - @substrat-run/engine-invites@0.5.0
  - @substrat-run/kernel@0.90.0
  - @substrat-run/adapter-cloudflare@0.90.0
  - @substrat-run/demo-callout@0.3.7
  - @substrat-run/demo-manyfold@0.7.6
  - @substrat-run/demo-meridian@0.7.2
  - @substrat-run/engine-absence@0.5.2
