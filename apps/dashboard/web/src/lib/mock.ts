...
export const MOCK_OBSERVABILITY_LOGS: ObservabilityLogEvent[] = [
  ...
  { timestamp: now - 19 * 60e3, level: 'log', message: '{"op":"listTickets","durationMs":11}', service: svcPrev, outcome: 'ok', trigger: 'default.listTickets', eventType: 'rpc', entrypoint: 'ScopeDO', requestId: 'QPD9D3939D9QDDPL', cpuTimeMs: 0.3, wallTimeMs: 11, raw: { $metadata: { trigger: 'default.listTickets', level: 'log' }, $workers: { eventType: 'rpc', entrypoint: 'ScopeDO', outcome: 'ok', cpuTimeMs: 0.3 } } },
