...
import type { ConnectionSweepView as WorkerConnectionSweepView, ConnectionSweepRow as WorkerConnectionSweepRow } from '../../../src/connection-sweep';
import type { AppHealthRow as WorkerAppHealthRow } from '../../../src/fleet-health';
import type { AppMetricsRow as WorkerAppMetricsRow, AppMetricsView as WorkerAppMetricsView } from '../../../src/app-metrics';
...
export const APP_METRICS_ROW_PARITY: Equal<WireAppMetricsRow, WorkerAppMetricsRow> = true;
export const APP_METRICS_VIEW_PARITY: Equal<WireAppMetricsView, WorkerAppMetricsView> = true;
