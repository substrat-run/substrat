...
the dashboard, the console, the builder, the docs site. It is published here so that
...
- `packages/contracts`, `packages/cli`, `demos/*` — **Apache-2.0**
- `packages/kernel`, `packages/adapter-*`, `packages/control-plane-api`, `engines/*` —
