...
# Conformance receipt — @substrat-run/engine-absence

11 operations · 4 narrowed checks · 4 conformance pairs driven
...
**4 pairs driven** across 4 of this package's 4 narrowed checks.

| Operation | Permission | Narrows to | Driven |
| --- | --- | --- | --- |
| `absence/availability` | `absence:read` | whole ref from `subject` | `employee` |
| `absence/balance` | `absence:read` | whole ref from `subject` | `employee` |
| `absence/list-entries` | `absence:read` | whole ref from `subject` | `employee` |
| `absence/request` | `absence:request` | whole ref from `subject.ref` | `employee` |
...
| --- | --- | --- |
| Node-level check | 7 | `absence/cancel`, `absence/configure-leave-type`, `absence/decide`, `absence/expire-stale`, `absence/list-leave-types`, `absence/list-requests`, `absence/record-entry` |
