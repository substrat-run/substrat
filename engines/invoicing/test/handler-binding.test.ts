...
// @ts-expect-error 'invoicing/list' is paged: the handler returns a Page, not its items
export const pagedBare: Handlers['invoicing/list'] = async () => declared<Out<'invoicing/list'>['items']>();
