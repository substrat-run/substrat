...
# Conformance receipt — @substrat-run/engine-booking

17 operations · 7 narrowed checks · 7 conformance pairs driven
...
| --- | --- | --- | --- |
| `booking/cancel` | `booking:cancel` | `reservation`, id from `reservationId` | `reservation` |
| `booking/confirm` | `booking:confirm` | `reservation`, id from `reservationId` | `reservation` |
| `booking/get` | `booking:read` | `reservation`, id from `reservationId` | `reservation` |
| `booking/join` | `booking:create` | `reservation`, id from `reservationId` | `reservation` |
| `booking/leave` | `booking:cancel` | `reservation`, id from `reservationId` | `reservation` |
| `booking/move` | `booking:move` | `reservation`, id from `reservationId` | `reservation` |
| `booking/open` | `booking:confirm` | `reservation`, id from `reservationId` | `reservation` |
...
| --- | --- | --- |
| Node-level check | 10 | `booking/availability`, `booking/complete`, `booking/create-resource`, `booking/expire`, `booking/hold`, `booking/list`, `booking/list-resources`, `booking/no-show`, `booking/set-resource-active`, `booking/start` |
