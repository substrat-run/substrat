...
// @ts-expect-error 'protocol/list-for-entity' is paged: the handler returns a Page, not its items
export const pagedBare: Handlers['protocol/list-for-entity'] = async () => declared<Out<'protocol/list-for-entity'>['items']>();
