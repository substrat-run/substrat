...
// @ts-expect-error 'metering/list-entries' is paged: the handler returns a Page, not its items
export const pagedBare: Handlers['metering/list-entries'] = async () => declared<Out<'metering/list-entries'>['items']>();
