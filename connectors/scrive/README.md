...
//    The sweeper is bound to the same base the registration named — the deployment
//    decides which Scrive it polls, in one place:
const sweeper = (h, id, o) => sweepScriveReconciliations(h, id, { ...o, baseUrl: SCRIVE_TESTBED });
