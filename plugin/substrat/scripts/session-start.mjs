#!/usr/bin/env node
// GENERATED by tools/plugin-emit.mts from packages/create-substrat/template/.substrat/hooks/session-start.mjs — do not edit by hand; edit the source and run `pnpm lint:plugin`.
/**
