...
global `fetch` is handed on as `globalThis.fetch.bind(globalThis)`, never bare — workerd
...
consent callback shipped green and failed every hosted round that way, #1263),
