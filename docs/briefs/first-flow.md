...
Read alongside [control-plane](../architecture/control-plane.md) (the directory surface this makes shared
and deployed), [kernel-design](../architecture/kernel-design.md) §5.5 (deployment topology) and §9 (the
published packages), and [generated-verticals](../strategy/generated-verticals.md) §2 (the loop this
...
the control plane orchestrate N deployments" ([kernel-design](../architecture/kernel-design.md) open
...
- **The scaling shape.** One vertical, one control plane. Facets-as-generic vs
  N-deployments ([generated-verticals](../strategy/generated-verticals.md) §6.3) is untouched.
- **The deploy *trigger*.** `wrangler deploy` by hand is the trigger for this milestone.
  ...
  [orchestration](../architecture/orchestration.md), which commits to **Workers for Platforms dispatch
  ...
  regardless ([generated-verticals](../strategy/generated-verticals.md) §1).
