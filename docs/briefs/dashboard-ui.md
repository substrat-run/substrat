...
[dashboard.md](../architecture/dashboard.md) (the *system/authority* spec — read it first for what the
...
[observability.md](../architecture/observability.md): tenant-facing numbers come only from the router's
...
*Source of truth for behaviour and scope is [dashboard.md](../architecture/dashboard.md); this file governs
