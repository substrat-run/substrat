...
Status: draft v0.2 · Last updated: 2026-07-28
...
interface DomainEvent<T = unknown> {
  ...
  authorization?: Array<{         // K-34: the checks the emitting operation passed —
    ...
    grantId?: GrantId;            //   set when the allow resolved via an entity grant
  }>;
