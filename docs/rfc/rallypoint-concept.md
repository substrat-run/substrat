...
status: historical
layer: plan
description: The RallyPoint concept — the racket-club demo that drove engine-booking; the demo is gone, the argument stays.
---

<!-- Retained from demos/rally/spec/concept.md when the demo was removed (2026-09-13). engines/booking.md and rfc/booking-social.md cite it as the driving vertical; nothing below was revised. -->
...
- **Tenant = the club operator**; **scope = the venue** (a club with two locations is one
  ...
  victim, matching `fsm`.
- **Critical scoping constraint** ([booking-social.md §3](booking-social.md)):
...
[engine-booking.md](../engines/booking.md) D-B, local intent is vertical
...
The primitive ([booking-social.md §2](booking-social.md)):
...
([kernel-design.md §4.3](../architecture/kernel-design.md)). This reuses the portal
...
tenant ([booking-social.md §1, §4](booking-social.md)). The demo ships
only the **seam**:
