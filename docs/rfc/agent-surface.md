...
· **Depends on:** [api-surface.md](../architecture/api-surface.md) (the emitted OpenAPI document),
[generated-verticals.md](../strategy/generated-verticals.md) and [builder-studio.md](../architecture/builder/studio.md)
(the hosted channel), [self-serve-deploy.md](../architecture/self-serve-deploy.md) (the push seam).
...
`apps/builder`. Fully designed elsewhere ([builder-studio.md](../architecture/builder/studio.md),
[builder-harness.md](../architecture/builder/harness.md)) and out of scope here except for one property
...
([api-surface.md](../architecture/api-surface.md)), a permission spine, and a tenancy model — so a token
