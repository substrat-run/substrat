...
**Status:** **built** — `substrat push/promote/preview`, dispatch namespaces; the serving half is superseded by D-37/K-33. This is the layer [first-flow](../briefs/first-flow.md) §5
...
pull-provisioning) and [first-flow](../briefs/first-flow.md) (the walking skeleton this is the
next step after).
