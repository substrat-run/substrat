...
A correction to [booking-social.md §2](../rfc/booking-social.md), which conflated two axes. They
...
([kernel-design.md §4.3](../architecture/kernel-design.md)), and for the padel case it carries the *global*
...
> precisely why [booking-social.md §3](../rfc/booking-social.md)'s scoping rule is mandatory: a
