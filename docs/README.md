...
How the platform works **today** — present tense. A document here may not say "will", "proposed" or "not built".
...
Handoffs with a short shelf life by design: briefs to a design tool, milestone plans. They become `historical` when consumed.
...
One per engine, mirroring `engines/*`. Three are still missing: workorder, invoicing, invites.
...
| [docs-restructure.md](rfc/docs-restructure.md) | `building` | Audit of docs/ and the restructure. Phases 0-3 done; Phase 4 is the gate and the content debt. |
...
This index is hand-maintained and should be generated — see
[rfc/docs-restructure.md](rfc/docs-restructure.md) §8.
