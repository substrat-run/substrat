...
status: canonical
layer: plan
description: The map of this directory. The prose is hand-written; the index between the INDEX markers is generated by tools/docs-structure.mjs from each document's frontmatter and re-emitted in CI.
---
...
[`DECISIONS.md`](DECISIONS.md) is the whole log — <!-- DECISIONS:COUNT -->102 entries<!-- /DECISIONS:COUNT -->, both layers, oldest first —
...
| document | status | |
|---|---|---|
| [crm-eff-adoption.md](briefs/crm-eff-adoption.md) | `historical` | What CRM-EFF can generate from Substrat's model packages, and what it still cannot. Re-derived 2026-09-09. |
