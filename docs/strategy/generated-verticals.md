...
as a design requirement), [kernel-design](../architecture/kernel-design.md) §5.5 (deployment topology), and
[control-plane](../architecture/control-plane.md) (the tenant/scope/entitlement surface this provisions
against).
...
three of [control-plane](../architecture/control-plane.md) §1.1's objections to merging deployments
...
- **This channel is a forcing function for the console.** §6.1's review gate is a screen
  someone has to click — [control-plane](../architecture/control-plane.md) §4.5 item 4, the permission diff.
