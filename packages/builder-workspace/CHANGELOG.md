...
- 19823fc: The builder workspace's path boundary now actually stops a symlink leaving it, which its own description already claimed it did.
...
- ac6bf64: The build phase reads the approved model (#681, context plumbing half).
