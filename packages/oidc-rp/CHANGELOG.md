...
- c8554a1: `oidc-rp` now holds a discovery document to what it is trusted with.
...
- 2ffed76: The RP now reads the profile claims from **UserInfo** when the ID token does not carry
...
- a4704de: `signVisitorIdentity` — vouch for the session this package established to a widget
