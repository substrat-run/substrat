...
- bd5c543: One browser can now hold several link shares at once. Before, opening a second link replaced the first.
...
- d7eb089: A vertical's MCP endpoint accepts a bearer token only if the token was minted for it.
