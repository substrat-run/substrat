...
# Conformance receipt — @substrat-run/demo-meridian

27 operations · 9 narrowed checks · 9 conformance pairs driven
...
**9 pairs driven** across 9 of this package's 9 narrowed checks.

| Operation | Permission | Narrows to | Driven |
| --- | --- | --- | --- |
| `hr/balance` | `absence:read` | `employee`, id from `employeeId` | `employee` |
| `hr/log-time` | `time:report` | `employee`, id from `employeeId` | `employee` |
| `hr/my-expenses` | `expense:read` | `employee`, id from `employeeId` | `employee` |
| `hr/my-requests` | `absence:read` | `employee`, id from `employeeId` | `employee` |
| `hr/request-leave` | `absence:request` | `employee`, id from `employeeId` | `employee` |
| `hr/submit-expense` | `expense:submit` | `employee`, id from `employeeId` | `employee` |
| `hr/timeline` | `absence:read` | `employee`, id from `entityId` | `employee` |
| `hr/timesheet` | `time:read` | `employee`, id from `employeeId` | `employee` |
| `hr/verify-contract` | `protocol:read` | `protocol`, id from `instanceId` | `protocol` |
...
| --- | --- | --- |
| Node-level check | 18 | `hr/accrue`, `hr/create-employee`, `hr/create-project`, `hr/decide-expense`, `hr/decide-leave`, `hr/define-leave-type`, `hr/employment-terms`, `hr/issue-employment-contract`, `hr/list-employees`, `hr/list-expenses`, `hr/list-leave-types`, `hr/list-projects`, `hr/list-requests`, `hr/payroll-export`, `hr/roster`, `hr/set-employment-terms`, `hr/start-onboarding`, `hr/whoami` |
