...
export const meridianModule: ModuleRegistration = {
  ...
  operations: {
    ...
    'hr/list-leave-types': listLeaveTypesOp,
    'hr/accrue': accrueOp,
    'hr/balance': balanceOp,
    'hr/request-leave': requestLeaveOp,
    'hr/decide-leave': decideLeaveOp,
    'hr/list-requests': listRequestsOp,
    'hr/my-requests': myRequestsOp,
    'hr/create-project': createProjectOp,
    'hr/list-projects': listProjectsOp,
    'hr/log-time': logTimeOp,
    'hr/timesheet': timesheetOp,
    'hr/submit-expense': submitExpenseOp,
    'hr/decide-expense': decideExpenseOp,
    'hr/list-expenses': listExpensesOp,
    'hr/my-expenses': myExpensesOp,
    'hr/payroll-export': payrollExportOp,
    'hr/set-employment-terms': setTermsOp,
    'hr/employment-terms': termsOp,
    'hr/issue-employment-contract': issueContractOp,
