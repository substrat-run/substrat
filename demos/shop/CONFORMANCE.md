...
# Conformance receipt — @substrat-run/demo-shop

21 operations · 1 narrowed check · 1 conformance pair driven
...
| --- | --- | --- | --- |
| `shop/order` | `order:read` | `order`, id from `orderId` | `order` |
...
| --- | --- | --- |
| Node-level check | 18 | `shop/add-to-cart`, `shop/add-variant`, `shop/cart`, `shop/catalog`, `shop/checkout`, `shop/close-order`, `shop/create-cart`, `shop/create-customer`, `shop/create-discount`, `shop/create-product`, `shop/fulfil-order`, `shop/orders`, `shop/publish-product`, `shop/quote`, `shop/remove-line`, `shop/set-line-qty`, `shop/set-stock`, `shop/stock-overview` |
| Per-entity proof walk (`narrows`) | 2 | `shop/my-customer`, `shop/portal-orders` |
