...
/**
 * Workshop price-list management (fsm spec/views.md §1.5, v0 simple):
 * editable table plus the "test article price" simulator — pick article +
 * qty, see the priced result and which rule produced it (same rules as
 * priced completion: min-qty applied, internal articles dropped).
 */
export function PricesView() {
  ...
  return (
    <>
      <h1>Prislista</h1>
      <p className="sub">
        Verkstadens prissättning är vertikalens — minsta debitering (halvtimmen) och interna
        artiklar tillämpas i prissatta slutförandet, aldrig i motorn.
      </p>
      ...
      <div className="card">
        ...
        <div className="row">
          ...
          {sim && !DECIMAL.test(simQty) && <span className="muted">Ange ett antal, t.ex. 0.25</span>}
        </div>
      </div>
    </>
  );
