...
| --- | --- | --- |
| Node-level check | 9 | `callout/complete-workorder`, `callout/create-customer`, `callout/create-facility`, `callout/create-workorder`, `callout/instantiate-protocol`, `callout/list-customers`, `callout/price-list`, `callout/search-customers`, `callout/upsert-price` |
| Per-entity proof walk (`narrows`) | 2 | `callout/portal-orders`, `callout/whoami` |
