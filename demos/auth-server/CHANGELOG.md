...
- 429cc84: The auth server's **Your account** page now lists every app the signed-in account is a member of, with a link into each, across every team whose apps sign in with this auth server.
...
- bca3315: An issuer upgraded from 1.6 can be signed into again.
